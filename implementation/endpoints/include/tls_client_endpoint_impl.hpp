...
#ifndef VSOMEIP_V3_TLS_CLIENT_ENDPOINT_IMPL_HPP_
#define VSOMEIP_V3_TLS_CLIENT_ENDPOINT_IMPL_HPP_
...
public:
    tls_client_endpoint_impl(const std::shared_ptr<endpoint_host>& _endpoint_host,
...
private:
    ...
    typedef boost::asio::ip::tcp::resolver::results_type ssl_endpoint_t;
    ...
    bool verify_certificate_cbk(bool preverified, boost::asio::ssl::verify_context& ctx);
    ...
    void shutdown_and_close_ssl_socket(bool _recreate_socket);
    void shutdown_and_close_ssl_socket_unlocked(bool _recreate_socket);
...
#endif // VSOMEIP_V3_TLS_CLIENT_ENDPOINT_IMPL_HPP_
